...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof gzeroTo, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 4', function test( t ) {
	t.strictEqual( gzeroTo.length, 4, 'has expected arity' );
	t.end();
});
